...
When you're ready to create a pull request into the development branch, add another react dev as a reviewer. We should go through the merge conflicts together to avoid breaking the app.
